...
public class DriveConstants {
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(5.5, 0, 4.5,
      12.5);//16.2997);//getMotorVelocityF(MAX_RPM / 60 * TICKS_PER_REV));
//35.8478 is kf, should go above i think
    /*
     ...
     */
    public static double MAX_VEL = 20.34227;//50.36ish?//52.48291908330528;//may change later
